...
# Функция вызовов окна результатов    
def popup_window(n1, c1, n2, c2):
    ...
    txtOutput = tk.Text(window, font = ('Courier New', 9, 'bold'))
    ...
    # Добавление ввода возможных разбросов
    z1 = 1.96
    ...
    lblComment95 = tk.Label(window, text = "95% уверенность:", font = ('Helvetica', 10, 'bold', 'italic'), bg = '#FFFFFF')
    ...
    btnClosePopup = tk.Button(window, text="Закрыть", font = ('Helvetica', 10, 'bold'), fg = '#E5E5E5', background="#0000FF", command=window.destroy)
    btnClosePopup.place(x=200, y=450, width=90, height=30)
    
    # Перевод фокуса на заданное окно
    window.focus_force()
...
lblTitle = tk.Label(text = "A/B калькулятор", font = ('Helvetica', 16, 'bold', 'italic'), fg = '#993300', bg = '#FFFFFF')
...
btnProcess = tk.Button(root, text="Расчитать", font = ('Helvetica', 10, 'bold'), fg = '#E5E5E5', background="#008000", command=do_processing)
